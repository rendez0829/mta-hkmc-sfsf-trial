		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comhkmctrialztmp001-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhkmctrialztmp001-display": {
								"semanticObject": "comhkmctrialztmp001",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hkmc.trial.ztmp001",
									"url": sap.ui.require.toUrl("com/hkmc/trial/ztmp001")
								}
							}
						}
					}
